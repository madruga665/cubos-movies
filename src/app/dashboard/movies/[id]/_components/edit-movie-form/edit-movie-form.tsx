...
import { CreateMovieFormValues, createMovieSchema } from '@/app/dashboard/adicionar-filme/_components/create-movie-form/create-movie-schema';
import { updateMovieAction } from '../../edit-action';
